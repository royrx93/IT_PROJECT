<template>
  <body>
    <div v-for="article in articles" :key="article.title">
      <div
        style="background: rgba(25,25,25,.5); margin-left: 60px; margin-right: 60px; margin-bottom: 5%"
        v-if="article.title == this.$route.params.title"
      >
        ...
        <div style="width: 100%">
          <img class="image" :src="article.image_url" />
        </div>
