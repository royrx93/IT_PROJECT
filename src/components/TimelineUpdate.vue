<template>
  ...
  <input type="month" name="string" v-model="month" placeholder="month" />
  <br />
  <input
    type="description"
    name="description"
  ...
  />
  <br />
  <button @click="timelineUpdate" to="/timeline">Update</button>
</template>

<script>
import AuthenticationService from "../services/TimelineUpdateService";
export default {
  data() {
    return {
      year: "",
